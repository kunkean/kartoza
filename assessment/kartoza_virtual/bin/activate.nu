...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/home/kunke/git/kartoza/assessment/kartoza_virtual'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/home/kunke/git/kartoza/assessment/kartoza_virtual/bin/deactivate.nu'
